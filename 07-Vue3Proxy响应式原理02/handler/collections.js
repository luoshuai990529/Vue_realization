import { registerRunningReaction, hasRunningReaction, queueReactionsForOperation } from '../reaction.js';
import { proxyToRaw, rawToProxy, isObject, hasOwnProperty } from '../internals.js';
import { reactive } from '../reactive.js';

/** 对于返回值 如果是复杂类型 再进一步的定义为响应式 */
function findReactive(obj) {
...
export const instrumentations = {
  ...
  forEach(cb, ...args) {
     ...
     */
    const wrappedCb = (value, ...rest) => cb(findReactive(value), ...rest);
